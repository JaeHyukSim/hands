...
//	http://localhost:8001/review/swagger-ui.html
	...
	public Docket api() {
		...
		return new Docket(DocumentationType.SWAGGER_2).apiInfo(apiInfo()).groupName(version).select()
					.apis(RequestHandlerSelectors.basePackage("com.bangkoklab.controller"))
...
//		return regex("/admin/.*");
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title(title)
				.description("<h3>SSAFY API Reference for Developers</h3>Swagger를 이용한 GuestBook API<br><img src=\"ssafy.png\">") 
